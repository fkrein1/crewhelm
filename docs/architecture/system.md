...
| `OwnerControlPlane`  | Agent and connection lifecycle, safe provider auth-config references and browser-setup digests/plans, grants, Briefs, bounded MCP authoring drafts, Recipe installation receipts, Event Triggers and Schedules, Workflow plans and projections, Run admission, owner inbox, approvals, effect reconciliation, and audit |
