...
<p align="center">
  ...
  <strong><a href="docs/reference/mcp/index.md">MCP reference</a></strong> ·
...
> Workflows; Recipe discovery, installation, authoring, and publication; deterministic authority,
...
- [MCP tool reference](docs/reference/mcp/index.md) — generated by theme from the authenticated
  catalog and progressive operation schemas.
