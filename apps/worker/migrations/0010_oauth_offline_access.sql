...
SET "allowedScopes" = '"[\"control:read\",\"control:write\",\"agents:read\",\"agents:write\",\"connections:read\",\"connections:write\",\"connection-configs:read\",\"connection-configs:write\",\"integrations:read\",\"offline_access\"]"'
